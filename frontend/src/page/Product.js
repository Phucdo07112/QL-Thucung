          ...
          <div className="flex-1">
            ...
            <div className="mt-5 border-2 p-4 rounded-lg">
              ...
              <div className="mt-5 flex flex-col gap-5 text-[15px] font-medium">
                <div className="flex items-center justify-between cursor-pointer text-gray-500">
                  Dog Food <AiOutlineRight />
                </div>
                <div className="flex items-center justify-between cursor-pointer text-gray-500">
                  Pet Care <AiOutlineRight />
                </div>
                <div className="flex items-center justify-between cursor-pointer text-gray-800">
                  Pet Natural <AiOutlineRight className="text-red-700" />
                </div>
                <div className="flex items-center justify-between cursor-pointer text-gray-500">
                  Toys for Pets <AiOutlineRight />
                </div>
                <div className="flex items-center justify-between cursor-pointer text-gray-500">
                  Clothing <AiOutlineRight />
                </div>
                <div className="flex items-center justify-between cursor-pointer text-gray-500">
                  Healthy Food <AiOutlineRight />
                </div>
              </div>
            </div>
          </div>
          <div className="flex-4">
            ...
            <div className="mt-5">
                <Link to="/productDetails" className="grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-5">
                    <div className=" cursor-pointer group relative h-[380px] w-[300px] ">
                        <div className="transition-all duration-300 ease-in-out bg-[#FAF7F2] rounded-lg p-3 absolute top-0 left-0 group-hover:top-[-15px] ">
                        ...
                        <div className="flex flex-col items-center absolute bottom-0 left-1/2 transform -translate-x-1/2">
                            ...
                            <p className="text-lg font-medium">Eatmeet food</p>
